...
export class Animator extends Component {
  ...
  /**
   * Check anyState noExitTime transitions before crossFade updates.
   * If a matching transition is found, interrupt the crossFade and let the new state consume deltaTime.
   * @returns true if the crossFade was interrupted
   */
